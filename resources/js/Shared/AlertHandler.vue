...
<template>
    <div
        ...
        :class="{
            ...
            'border-emerald-700 dark:border-emerald-500 ring-emerald-700 dark:ring-emerald-700 bg-emerald-100 dark:bg-emerald-500 text-dark hover:bg-emerald-700 hover:border-emerald-700 hover:dark:bg-emerald-600 hover:dark:border-emerald-600': a.type === 'success'
        }" 
    >   
